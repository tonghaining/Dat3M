...
public class VisitorExtensionClangReflection extends VisitorExtension<Void> {
    ...
    public VisitorExtensionClangReflection(ProgramBuilder builder) {
    ...
    private void initPushConstant() {
        if (pushConstant == null) {
            ...
            throw new ParsingException("Cannot identify PushConstant referenced by CLANG extension");
        }
    }
