...
import com.dat3m.dartagnan.parsers.program.visitors.spirv.extenstions.VisitorExtensionClangReflection;
...
public class VisitorOpsExtension extends SpirvBaseVisitor<Void> {
    ...
    public VisitorOpsExtension(ProgramBuilder builder) {
        ...
        VisitorExtensionClangReflection clang = new VisitorExtensionClangReflection(builder);
        ...
        this.availableVisitors.put("OpenCL.std", clang);
    }
