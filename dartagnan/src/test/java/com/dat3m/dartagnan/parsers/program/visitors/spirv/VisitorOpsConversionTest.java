...
public class VisitorOpsConversionTest {
    ...
    public void doTestOpsBitcastUint32ToUchar() {
        ...
        builder.mockVirtualVariable("%value1", "%_ptr_Function_uint");
        ...
        // then
        Expression value1 = builder.getExpression("%value1");
        Expression value2 = builder.getExpression("%value2");
        assertEquals(((ScopedPointerType) builder.getType("%_ptr_Function_uint")).getPointedType(), ((ScopedPointerVariable) value1).getInnerType());
        assertEquals(((ScopedPointerType) builder.getType("%_ptr_Function_uchar")).getPointedType(), ((ScopedPointerVariable) value2).getInnerType());
    }
    ...
    public void doTestOpsBitcastUint32VectorToUcharVector() {
        ...
        builder.mockVirtualVariable("%value1", "%_ptr_Function_uint_4");
        ...
        Expression value1 = builder.getExpression("%value1");
        Expression value2 = builder.getExpression("%value2");
        assertEquals(((ScopedPointerType) builder.getType("%_ptr_Function_uint_4")).getPointedType(), ((ScopedPointerVariable) value1).getInnerType());
        assertEquals(((ScopedPointerType) builder.getType("%_ptr_Function_uchar_4")).getPointedType(), ((ScopedPointerVariable) value2).getInnerType());
    }
