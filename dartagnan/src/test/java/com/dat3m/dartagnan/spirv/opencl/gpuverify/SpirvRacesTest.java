package com.dat3m.dartagnan.spirv.opencl.gpuverify;
...
public class SpirvRacesTest {
    ...
    public static Iterable<Object[]> data() throws IOException {
        return Arrays.asList(new Object[][]{
                ...
                {"inter_group_and_barrier_flag_tests/fail/no_barrier_flags.spvasm", 1, FAIL},
                ...
                {"null_pointers/null_pointer_assignment_unequal.spvasm", 1, FAIL},
                {"null_pointers/null_pointer_greater.spvasm", 1, FAIL},
                ...
                // TODO: Analyze
                // {"test_mod_invariants/local_direct.spvasm", 1, UNKNOWN},
                ...
                // {"inter_group_and_barrier_flag_tests/fail/bad_write_then_read.spvasm", 1, FAIL},
                ...
                // {"async_work_group_copy/fail/test13.spvasm", 1, FAIL},
                // {"async_work_group_copy/fail/test7.spvasm", 1, ??},
                // {"async_work_group_copy/fail/test8.spvasm", 1, ??},
                // {"async_work_group_copy/fail/test9.spvasm", 1, ??},
                // {"induction_variable.spvasm", 1, PASS},
                // {"inter_group_and_barrier_flag_tests/fail/missing_global_barrier_flag.spvasm", 1, FAIL},
                // {"inter_group_and_barrier_flag_tests/fail/sync_within_group_wrong_flag.spvasm", 1, FAIL},
                ...
                // {"k-induction/amazingreduction.spvasm", 1, FAIL},
                ...
                // {"test_line_number_problem.spvasm", 1, FAIL},
                // {"test_mod_invariants/local_reduce_strength.spvasm", 1, PASS},

                // Unsupported spir-v ops
                // {"alignment/int3int4.spvasm", 1, PASS},
                // {"alignment/race_location.spvasm", 1, FAIL},
                // {"async_work_group_copy/fail/test1.spvasm", 1, FAIL},
                // {"async_work_group_copy/fail/test10.spvasm", 1, FAIL},
                // {"async_work_group_copy/fail/test14.spvasm", 1, FAIL},
                // {"async_work_group_copy/fail/test15.spvasm", 1, ??},
                // {"async_work_group_copy/fail/test16.spvasm", 1, ??},
                // {"async_work_group_copy/fail/test17.spvasm", 1, ??},
                // {"async_work_group_copy/fail/test18.spvasm", 1, ??},
                // {"async_work_group_copy/fail/test2.spvasm", 1, FAIL},
                // {"async_work_group_copy/fail/test4.spvasm", 1, FAIL},
                // {"async_work_group_copy/fail/test5.spvasm", 1, FAIL},
                ...
                // {"async_work_group_copy/pass/test6.spvasm", 1, ??},
                // {"async_work_group_copy/pass/test7.spvasm", 1, ??},
                // {"async_work_group_copy/pass/test8.spvasm", 1, ??},
                // {"async_work_group_copy/pass/test9.spvasm", 1, ??},
                ...
                // {"benign_race_tests/fail/writewritearray_adversarial.spvasm", 1, FAIL},
                // {"benign_race_tests/pass/writeinloop.spvasm", 1, FAIL},
                // {"ceil.spvasm", 1, PASS},
                ...
                // {"globalarray/fail.spvasm", 1, FAIL},
                // {"globalarray/pass.spvasm", 1, PASS},
                // {"imagetests/fail2dimagecopy.spvasm", 1, FAIL},
                // {"imagetests/test2dimagecopy.spvasm", 1, PASS},
                // {"imagetests/testsampler.spvasm", 1, PASS},
                // {"imagetests/testsampler2.spvasm", 1, PASS},
                // {"misc/fail/4d_array_of_vectors_race.spvasm", 1, FAIL},
                // {"misc/fail/miscfail9.spvasm", 1, FAIL},
                // {"misc/fail/vector_element_race.spvasm", 1, FAIL},
                // {"misc/pass/misc15.spvasm", 1, FAIL},
                // {"misc/pass/misc16.spvasm", 1, PASS},
                // {"misc/pass/misc7.spvasm", 1, PASS},
                // {"misc/pass/misc8.spvasm", 1, PASS},
                // {"noraceduetoreturn.spvasm", 1, PASS},
                // {"null_pointers/store_to_null_and_non_null.spvasm", 1, ??},
                ...
                // {"pointertests/test_copy_between_memory_spaces2.spvasm", 1, FAIL},
                // {"pow2/64bit_loopcounter.spvasm", 1, PASS},
                // {"pow2/64bit_relational.spvasm", 1, PASS},
                // {"saturate/uadd.spvasm", 1, ??},
                // {"saturate/usub.spvasm", 1, ??},
                // {"shuffle/shuffle.spvasm", 1, PASS},
                // {"simplebinomialoptions.spvasm", 1, PASS},
                // {"sourcelocation_tests/races/fail/write_write/elem_width_16.spvasm", 1, FAIL},
                ...
                // {"warpsync/2d.spvasm", 1, FAIL},
                // {"warpsync/broken_shuffle.spvasm", 1, FAIL},
                // {"warpsync/shuffle.spvasm", 1, FAIL},

                // Compiler eliminated reads of unused value
                // {"misc/fail/miscfail8.spvasm", 1, FAIL},
                // {"pointertests/test_copy_between_memory_spaces.spvasm", 1, FAIL},
                // {"sourcelocation_tests/race_from_call.spvasm", 1, FAIL},
                // {"sourcelocation_tests/race_from_call_in_loop.spvasm", 1, FAIL},
                // {"sourcelocation_tests/races_from_indirect_calls.spvasm", 1, FAIL},

                // Compiler eliminated the whole main function
                // {"addressofinit.spvasm", 1, PASS},
                // {"array_bounds_tests/array_in_array.spvasm", 1, FAIL},
                // {"array_bounds_tests/array_in_array_2.spvasm", 1, PASS},
                // {"array_bounds_tests/array_in_array_param.spvasm", 1, FAIL},
                ...
                // {"benign_race_tests/pass/writeafterread.spvasm", 1, FAIL},
                ...
                // {"misc/fail/4d_array_of_structs_race.spvasm", 1, FAIL},
                // {"misc/fail/4d_array_race.spvasm", 1, FAIL},
                // {"misc/fail/4d_array_with_casting.spvasm", 1, FAIL},
                // {"misc/fail/miscfail10.spvasm", 1, FAIL},
                ...
                // {"null_pointers/load_from_null.spvasm", 1, ??},
                ...
                // {"pointertests/test_opencl_local_array.spvasm", 1, ??},
                // {"pointertests/test_opencl_local_param.spvasm", 1, ??},
