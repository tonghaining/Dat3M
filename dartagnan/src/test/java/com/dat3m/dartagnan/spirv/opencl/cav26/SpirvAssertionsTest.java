...
public class SpirvAssertionsTest {
    ...
    public static Iterable<Object[]> data() throws IOException {
        return Arrays.asList(new Object[][]{
                ...
                {"ma/arrayfire-fast-2.1.2.spvasm", 2, PASS},
                {"ma/arrayfire-fast-lc2gb.spvasm", 2, FAIL},
                ...
                {"benchmarks/corr.spvasm", PASS},
                {"benchmarks/iriw.spvasm", PASS},
                {"benchmarks/mp.spvasm", PASS},
                {"benchmarks/mp-acq2rx.spvasm", FAIL},
                {"benchmarks/mp-rel2rx.spvasm", FAIL},
                {"benchmarks/sb.spvasm", PASS},
        });
    }
