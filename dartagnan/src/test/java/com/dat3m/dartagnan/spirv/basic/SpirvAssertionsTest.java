...
public class SpirvAssertionsTest {
    ...
    public static Iterable<Object[]> data() throws IOException {
        return Arrays.asList(new Object[][]{
                ...
                {"barrier-inlining-exists.spv.dis", OPENCL, 1, PASS},
                {"barrier-inlining-forall.spv.dis", OPENCL, 1, PASS},
                {"barrier-inlining-exists2.spv.dis", OPENCL, 1, FAIL},
                {"barrier-inlining-forall2.spv.dis", OPENCL, 1, FAIL},
                {"barrier-no-inlining-exists.spv.dis", OPENCL, 1, PASS},
                {"barrier-no-inlining-forall.spv.dis", OPENCL, 1, PASS},
                {"barrier-no-inlining-exists2.spv.dis", OPENCL, 1, FAIL},
                {"barrier-no-inlining-forall2.spv.dis", OPENCL, 1, FAIL},
        });
    }
