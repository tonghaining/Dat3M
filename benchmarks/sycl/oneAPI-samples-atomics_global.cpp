// https://github.com/oneapi-src/oneAPI-samples/blob/main/DirectProgramming/C%2B%2BSYCL/Jupyter/gpu-optimization-sycl-training/08_Atomic_Operations/lab/atomics_global.cpp
//==============================================================
